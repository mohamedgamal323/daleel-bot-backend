...
from src.backend.domain.persistence.dependencies import get_asset_repository
from ..integration.dependencies import get_llm_provider, get_vector_db
from src.backend.application.dtos.asset_dtos import CreateAssetRequestDto, UpdateAssetRequestDto
