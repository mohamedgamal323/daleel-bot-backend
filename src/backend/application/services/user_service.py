...
from src.backend.domain.persistence.user_repository import UserRepository
from src.backend.domain.entities.user import User
from src.backend.domain.enums.role import Role
from src.backend.domain.persistence.dependencies import get_user_repository
from src.backend.application.dtos.user_dtos import CreateUserRequestDto, UpdateUserRequestDto, UserRegistrationDto
